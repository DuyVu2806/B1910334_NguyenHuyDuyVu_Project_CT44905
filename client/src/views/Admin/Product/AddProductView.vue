                ...
                <div class="card shadow mb-5">
                    ...
                    <div class="card-body">
                        <form ref="productForm" @submit.prevent="addProduct">
                            ...
                            <button type="submit" class="btn btn-sm btn-outline-primary float-end">Add Product</button>
                        </form>
                    </div>
                </div>
            </div>
        ...
        async addProduct() {
            ...
            if (Object.keys(this.errors).length === 0) {
                try {
                    ...
                    const response = await axios.post("http://127.0.0.1:5000/api/product", formData);
                    const { data } = response;
                    console.log(data);
                    Swal.fire({
                        position: 'center',
